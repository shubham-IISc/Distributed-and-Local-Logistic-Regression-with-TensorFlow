...
#with regularization and constant learning rate in distributed settings

#server settings


parameter_servers=["10.1.1.252:2225"];
workers=["10.1.1.253:2223","10.1.1.251:2222"]
...
if FLAGS.job_name=='ps':
    ...
    with tf.device(tf.train.replica_device_setter(worker_device="/job:worker/task:%d" % FLAGS.task_index,cluster=cluster)):
        ...
        optimizer = tf.train.AdamOptimizer(learning_rate=lr).minimize(final_cost) 
